"""
Code for training Pix2Pix model using AMP.
...
def main():
    colossalai.launch_from_torch(config='./config_amp.py')
    ...
    G, train_dataloader, test_dataloader, _ = colossalai.initialize(g_model,
                                                                          G_optimizer,
                                                                          BCE_loss,
                                                                          train_dataloader,
                                                                          test_dataloader,
    ...
    D, _, _, _ = colossalai.initialize(d_model,
                                      D_optimizer,
                                      BCE_loss)
